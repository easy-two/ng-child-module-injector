...
export function resolve(ngModuleWebpackModule: any, compiler: Compiler) {
...
function resolveAndCompileFactory(ngModuleWebpackModule: any, compiler: Compiler): [string, NgModuleFactory<any>] {
...
function resolveFactory(ngModuleWebpackModule: any): [string, NgModuleFactory<any>] {
